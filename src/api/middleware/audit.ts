...
// Oracle P0-1 (W4 review): sha256Hex extracted to ./sha256.ts so the
// per-route render-watermark-off audit writes share the exact same hashing
// implementation as the global audit middleware.
